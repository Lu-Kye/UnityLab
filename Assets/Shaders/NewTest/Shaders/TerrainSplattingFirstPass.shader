Shader "KGame/Terrain Splatting First Pass" {
...
Dependency "AddPassShader" = "KGame/Terrain Splatting Add Pass"
Dependency "BaseMapShader" = "KGame/Terrain Splatting Base Pass"
