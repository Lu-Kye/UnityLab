Shader "KGame/Terrain Splatting Rain First Pass" {
...
Dependency "AddPassShader" = "KGame/Terrain Splatting Rain Add Pass"
Dependency "BaseMapShader" = "KGame/Terrain Splatting Rain Base Pass"
