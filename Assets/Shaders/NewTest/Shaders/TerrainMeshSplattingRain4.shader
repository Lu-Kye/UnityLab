Shader "KGame/Terrain Mesh Splatting Rain 4" {
...
void SplattingMeshTerrainUVs4(float2 uv, out float4 splattingPack0, out float4 splattingPack1) {
...
v2f vert (appdata_full v) {
    ...
    SplattingMeshTerrainUVs4(uv, splattingPack0, splattingPack1);
...
void SplattingMesh4(float4 splattingPack0, float4 splattingPack1, float2 splattingUV, out half3 albedo, out half3 localNormal, out half metallic, out half perceptualSmoothness, out half transparency) {
    half weight = 0.f;
...
void frag(v2f IN, out half4 color: SV_Target0) { 
    ...
    half transparency;
    SplattingMesh4(splattingPack0, splattingPack1, splattingUV, albedo, localNormal, metallic, perceptualSmoothness, transparency);
