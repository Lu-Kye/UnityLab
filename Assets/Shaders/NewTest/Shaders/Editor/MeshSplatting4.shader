Shader "KGame/Editor/Mesh Splatting 4" {
...
void SplattingMeshUVs4(float2 uv, out float4 splattingPack0, out float4 splattingPack1) {
...
v2f vert (appdata v) {
    ...
    SplattingMeshUVs4(uv, splattingPack0, splattingPack1);
