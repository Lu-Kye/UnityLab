Shader "KGame/Editor/Mesh Splatting 5" {
...
void SplattingMeshUVs5(float2 uv, out float4 splattingPack0, out float4 splattingPack1, out float4 splattingPack2) {
...
v2f vert (appdata v) {
    ...
    SplattingMeshUVs5(uv, splattingPack0, splattingPack1, splattingPack2);
