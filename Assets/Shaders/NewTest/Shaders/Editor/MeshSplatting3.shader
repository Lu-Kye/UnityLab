Shader "KGame/Editor/Mesh Splatting 3" {
...
void SplattingMeshUVs3(float2 uv, out float4 splattingPack0, out float4 splattingPack1) {
...
v2f vert (appdata v) {
    ...
    SplattingMeshUVs3(uv, splattingPack0, splattingPack1);
