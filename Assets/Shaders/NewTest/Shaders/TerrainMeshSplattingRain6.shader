Shader "KGame/Terrain Mesh Splatting Rain 6" {
...
void SplattingMeshTerrainUVs6(float2 uv, out float4 splattingPack0, out float4 splattingPack1, out float4 splattingPack2) {
...
v2f vert (appdata_full v) {
    ...
    SplattingMeshTerrainUVs6(uv, splattingPack0, splattingPack1, splattingPack2);
