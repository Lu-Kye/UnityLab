Shader "KGame/Terrain Mesh Splatting Rain 5" {
...
struct v2f {
    ...
    float4 splattingPack2 : TEXCOORD2;
...
void SplattingMeshTerrainUVs5(float2 uv, out float4 splattingPack0, out float4 splattingPack1, out float4 splattingPack2) {
...
v2f vert (appdata_full v) {
    ...
    SplattingMeshTerrainUVs5(uv, splattingPack0, splattingPack1, splattingPack2);
...
void SplattingMesh5(float4 splattingPack0, float4 splattingPack1, float4 splattingPack2, float2 splattingUV, out half3 albedo, out half3 localNormal, out half metallic, out half perceptualSmoothness, out half transparency) {
    half weight = 0.f;
...
void frag(v2f IN, out half4 color: SV_Target0) { 
    ...
    half transparency;
    SplattingMesh5(splattingPack0, splattingPack1, splattingPack2, splattingUV, albedo, localNormal, metallic, perceptualSmoothness, transparency);
